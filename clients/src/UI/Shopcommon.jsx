...
const Shopcommon = ({ title }) => {
  return (
    <section className="relative w-full py-16 bg-gradient-to-r from-slate-900 via-indigo-950 to-slate-900 border-b border-slate-800 flex items-center justify-center overflow-hidden">
