...
//   const chartData = hasRealData ? data : DEMO_DATA;

//   const COLORS = ['#a855f7', '#6366f1', '#ec4899', '#f59e0b', '#06b6d4'];

//   const CustomTooltip = ({ active, payload }) => {
//     if (active && payload && payload.length) {
//       const item = payload[0].payload;
//       return (
//         <div className="rounded-xl border border-slate-200 bg-white/95 p-3 shadow-lg backdrop-blur-sm dark:border-slate-800 dark:bg-slate-950/95 text-xs font-semibold">
//           <p className="text-slate-800 dark:text-slate-200 font-bold mb-1">{item.name}</p>
//           <div className="flex items-center gap-1.5 text-slate-500 dark:text-slate-400">
//             <span>Value:</span>
//             <span className="text-slate-800 dark:text-slate-100">${item.value.toLocaleString()}</span>
//           </div>
//         </div>
//       );
//     }
...
//           <p className="text-xs text-slate-450">Inventory value by product category</p>
//         </div>
//         <span
...
//           }`}
//         >
//           <span className={`h-1.5 w-1.5 rounded-full ${hasRealData ? "bg-emerald-500" : "bg-slate-400"}`} />
//           {hasRealData ? "Live Data" : "Demo Preview"}
//         </span>
//       </div>
